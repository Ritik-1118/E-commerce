        ...
        <div className="max-w-[85rem] mx-auto w-full border bg-slate-100 mt-8 pb-8 shadow-xl">
            ...
            <div className="pt-4 flex gap-4 overflow-hidden overflow-x-auto">
                { products && products.map( ( product, i ) => (
                    <NavLink to={`/product-details/${product._id}`} key={ i } className=" w-[200px] min-w-[210px] h-[300px] rounded-xl shadow-2xl transition ease-linear duration-300 transform hover:scale-110">
